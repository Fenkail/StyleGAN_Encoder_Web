...
def main():
    ...
    parser.add_argument('--src_dir', help='Directory with images for encoding', default='aligned_images_black')
    parser.add_argument('--generated_images_dir', help='Directory for storing generated images', default='generated_images_black')
    parser.add_argument('--dlatent_dir', help='Directory for storing dlatent representations', default='latent_representations_black')
